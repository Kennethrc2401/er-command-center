...
import { CalendarDays, MapPin, User, Clock, Info } from "lucide-react";
    ...
    <Card className="border-blue-100 bg-white shadow-xl rounded-[2.5rem] overflow-hidden">
      ...
      <CardContent className="p-8 flex flex-col md:flex-row gap-8 items-center">
        ...
        <div className="flex flex-col items-center justify-center bg-slate-50 border-2 border-slate-100 rounded-[2rem] h-24 w-24 shrink-0 shadow-inner">
          <span className="text-[10px] font-black uppercase text-blue-600 tracking-tighter">{month}</span>
        ...
        <div className="flex-1 space-y-4 text-center md:text-left">
          <div>
            <Badge className="bg-blue-50 text-blue-700 border-none mb-2 px-3 py-1 text-[10px] font-black uppercase tracking-widest">
              {appt.specialty}
            </Badge>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="flex items-center gap-3 justify-center md:justify-start">
              ...
              <span className="text-xs font-bold text-slate-600 truncate max-w-[150px]">{appt.address}</span>
            </div>
          </div>
